...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_vllizyt', 'template_yswlb9i', form.current, 'kGztQ_mOUXpnCki4B')
      e.target.reset()
      // show sent message
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">dhruv.modi2345@gmail.com</span>
              <a href="mailto:dhruv.modi2345@gmail.com" className="contact__button">Write me{" "} <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
            <div className="contact__card">
        ...
        <div className="contact__content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact__form">
            ...
            <div className="contact__form-div contact__form-area">
              <label className="contact__form-tag">Enter your message</label>
          ...
          {successMessage && (
            <span className="contact__success">{successMessage}</span>
          )}
        </div>
      </div>
    </section>
